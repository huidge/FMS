...
@Controller
@RequestMapping(value = "/fet/receivable")
public class FetReceivableController extends BaseController{
    ...
    @ResponseBody
    public ResponseData query(FetReceivable dto, @RequestParam(defaultValue = DEFAULT_PAGE) int page,
    ...
    @ResponseBody
    public ResponseData summaryQuery(FetReceivable dto, @RequestParam(defaultValue = DEFAULT_PAGE) int page,
        @RequestParam(defaultValue = DEFAULT_PAGE_SIZE) int pageSize, HttpServletRequest request) {
    	IRequest iRequest =createRequestContext(request);
    ...
    public ResponseData getAll(HttpServletRequest request) {
    	...
    	List<FetReceivable> data = service.selectAll(requestContext);
    ...
    @ResponseBody
    public ResponseData update(HttpServletRequest request,@RequestBody List<FetReceivable> dto) throws CommonException{
        IRequest requestCtx = createRequestContext(request);
        return new ResponseData(service.fetReceivableBatchUpdate(requestCtx, dto));
    }
}