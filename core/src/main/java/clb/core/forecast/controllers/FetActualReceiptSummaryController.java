...
@RequestMapping(value = "/fet/actual/receipt/summary")
@Controller
public class FetActualReceiptSummaryController extends BaseController{

	private static Logger log = LoggerFactory.getLogger(FetActualReceiptSummaryController.class);

	
    @Autowired
    private IFetActualReceiptSummaryService service;


    @RequestMapping(value = "/query")
    @ResponseBody
    public ResponseData query(FetActualReceiptSummary dto, @RequestParam(defaultValue = DEFAULT_PAGE) int page,
    ...
    @ResponseBody
    public ResponseData update(HttpServletRequest request,@RequestBody List<FetActualReceiptSummary> dtos,BindingResult result){
        ...
        return new ResponseData(service.actualReceiptSummaryBatchUpdate(requestCtx, dtos));
    }
    ...
    public ResponseData getAll(HttpServletRequest request) {
    	...
    	List<FetActualReceiptSummary> data = service.selectAll(requestContext);
        List<String> receiptPeriods = new ArrayList<>();
        for(FetActualReceiptSummary d:data){
    ...
    @ResponseBody
    public ResponseData delete(HttpServletRequest request,@RequestBody List<FetActualReceiptSummary> dto){
