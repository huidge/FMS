...
import clb.core.fnd.dto.FileObject;
	...
	public Map<String, String> uploadFile(String bucketName, String objectKey, InputStream inputStream) {
		...
		try {
			...
			if (!ossClient.doesBucketExist(bucketName)) {
				...
				createBucketRequest.setCannedACL(bucketName == FndUtil.WG_PRIVATE_BUCKET
			...
			resultMap.put("url", "http://" + bucketName + '.' + endpoint + '/' + objectKey);
