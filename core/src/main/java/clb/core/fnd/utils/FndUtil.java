...
public class FndUtil {
	 ...
	 * 项目简码,原纸交易平台
	 */
	public static final String WG_PROJECT_CODE = "pack";
	/**
	 * OSS公共读 BUCKET
	 */
	...
	public static void main(String[] args) {
		// 输出测试语句
		System.out.println(FndUtil.getNumberFormat(100L, 4));
	}
	...
	public static Locale getLocale(String lang){
		...
		String[] localeInfo = lang.split("_");
		Locale locale = null;
		if(localeInfo.length == 1){
			locale = new Locale(localeInfo[0]);
		}else{
