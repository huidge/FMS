...
public class WpLoginAuthenticationProvider extends
    ...
    protected final UserDetails retrieveUser(String username,
        ...
        try {
            ...
            String appId=((LinkedHashMap)authentication.getDetails()).get("appId")==null?"":((LinkedHashMap)authentication.getDetails()).get("appId").toString();
            String isApp=((LinkedHashMap)authentication.getDetails()).get("isApp")==null?"":((LinkedHashMap)authentication.getDetails()).get("isApp").toString();
            loadedUser = getUserDetailsService().loadUserByUsername(username,
                    password,appId,isApp);// 区别在这里
